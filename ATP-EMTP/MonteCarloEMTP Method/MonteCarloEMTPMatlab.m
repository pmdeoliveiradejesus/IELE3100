...
%w=263;
D = 100; %Cantidad de descargas aleatorias;
%%% Otros datos
...
% Imprimir por pantalla resultados para w1, w2, w3, w4 y w5.

%   aislamiento (m) iteracion nfo probabilidad tasa 
[   
     w(1)/100   kk nfo(kk,1) P(kk,1) T(kk,1);
      w(2)/100   kk nfo(kk,2) P(kk,2) T(kk,2);
      w(3)/100   kk nfo(kk,3) P(kk,3) T(kk,3);
     w(4)/100   kk nfo(kk,4) P(kk,4) T(kk,4);
